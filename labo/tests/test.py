...
from labo import optimized_swap, \
instruction, push_swap, swap_stack_b_0, swap_stack_b_1, swap_stack_b_2, swap_checker, swap_stack_b_3
...
def test06():
    ...
    for (index_a, index_b) in itertools.combinations(
        ...
        psw.stack_b = [i for i in range(100)]
        function_name, step = optimized_swap(
                psw, index_a, index_b, len(psw.stack_b)
                )
        # print(psw.stack_b)
        rlist.append((
            step,
