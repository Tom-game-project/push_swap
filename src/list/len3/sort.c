...
/*   Updated: 2024/12/16 18:06:57 by tmuranak         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef int	(*funclist[3][3])(t_node **ops);
...
void	set_len3_func(int (*func[3][3])(t_node **ops))
{
	func[0][0] = NULL;
	func[0][1] = len3_0_1;
	func[0][2] = len3_0_2;
...
int	len3_sort_base(t_node **node_a, t_node **ops, int base)
{
	...
	set_arr(*node_a, arr);
	set_len3_func(func);
	if (func[arr[0] - base][arr[1] - base](ops))
		return (1);
	return (0);
}
